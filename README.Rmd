...
[![Codecov test coverage](https://codecov.io/gh/statnmap/squirrels.fusen/branch/main/graph/badge.svg)](https://codecov.io/gh/statnmap/squirrels.fusen?branch=main)
<!-- badges: end -->

The goal of {squirrels.fusen} is to present an example of package built with [{fusen}](https://github.com/ThinkR-open/fusen).  
